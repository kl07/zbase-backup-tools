...
SPLIT_SIZE = 512
DEL_COMMAND = "del"
BLOBRESTORE_JOBS_DIR = '/var/opt/blobrestore/jobs/'
BLOBRESTORE_PROCESSED_JOBS_DIR = '/var/opt/blobrestore/processed_jobs/'
SYSLOG_TAG_BLOBRESTORE = 'blobrestore'
BLOBRESTORE_DAEMON_LOG = '/var/opt/blobrestore/daemon.log'
BACKUP_ARRAY_IPLIST = 's3://zynga-common/membase-backup-production-test2/configs/array_ips.list'
